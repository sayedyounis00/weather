      ...
      body: SingleChildScrollView(
        child: FutureBuilder<WeatherModel>(
          ...
          builder: (context, snapshot) {
            String giveWeather() {
              if (snapshot.data!.condition == 'Sunny') {
                return 'assets/sun.png';
              } else if (snapshot.data!.condition == 'Patchy rain nearby') {
                return 'assets/heavy-rain.png';
              } else if (snapshot.data!.condition == 'Clear') {
                return 'assets/cloudy.png';
              } else if (snapshot.data!.condition == 'Clear') {
                return 'assets/cloudy.png';
              } else if (snapshot.data!.condition == 'Light rain shower') {
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return CustomWeatherCard(
                            ...
                            temp: snapshot.data!.tempList[index], imageCondition: giveWeather(),
                          );
                        },
                      ),
                    ),
